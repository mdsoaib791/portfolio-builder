...
import { useGetUserByUserId } from "@/hooks/services-hook/use-user.service.hook";
...
export function AboutSection() {
  ...
  const userInfoResponse = useGetUserByUserId(userId);

  useEffect(() => {
    if (userInfoResponse.isSuccess) {
      const response = userInfoResponse.data?.data?.data as UserDto | undefined;
      setUser(response);
    }
  }, [userInfoResponse.isSuccess, userInfoResponse.data]);
